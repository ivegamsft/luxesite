...
**3. Design Direction**
How this should feel. What aesthetic approach fits. Reference the project's design context from `.agents/skills/impeccable/context.md` and explain how this feature should express it.
